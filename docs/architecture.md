...
Phase 1 — Domain foundation. Project, Task, Goal entities and invariants implemented. Dependency graph with traversal, cycle detection, and deterministic topological ordering implemented. Scheduling and critical-path analysis implemented. Decision engine with candidate selection, additive scoring, and deterministic tie-breaking implemented. This document records the intended architecture and is expected to evolve through documented decisions.
